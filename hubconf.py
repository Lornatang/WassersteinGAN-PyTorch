...
Usage:
    import torch
    model = torch.hub.load("Lornatang/WassersteinGAN-PyTorch", "mnist", pretrained=True)
"""
import torch
...
model_urls = {
    "lsun": "https://github.com/Lornatang/WassersteinGAN-PyTorch/releases/download/0.1.0/mnist-469fd083.pth"
}
